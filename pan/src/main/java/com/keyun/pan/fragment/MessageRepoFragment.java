 ...
 */
public class MessageRepoFragment extends BaseFragment {

    private final String TAG = MessageRepoFragment.class.getName();
    ...
    public static MessageRepoFragment newInstance() {
        MessageRepoFragment f = new MessageRepoFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            mData = db.selector(PushMessage.class).where("type", "=", 3).findAll();
        } catch (DbException e) {
            e.printStackTrace();
        }
