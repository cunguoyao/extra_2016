...
public class MessageShareFragment extends BaseFragment {
    ...
    private final String TAG = MessageShareFragment.class.getName();
    ...
    public static MessageShareFragment newInstance() {
        MessageShareFragment f = new MessageShareFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            mData = db.selector(PushMessage.class).where("type", "=", 4).or("type", "=", 5).findAll();
        } catch (DbException e) {
            e.printStackTrace();
        }
