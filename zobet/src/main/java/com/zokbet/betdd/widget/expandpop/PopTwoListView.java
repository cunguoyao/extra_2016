package com.zokbet.betdd.widget.expandpop;
...
public class PopTwoListView extends LinearLayout {
    ...
    private OnSelectListener mOnParentSelectListener;
    ...
    private void init(Context context) {
        ...
        parentListViewAdapter.setOnItemClickListener(new PopViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(PopViewAdapter adapter, int position) {
                if(mOnParentSelectListener != null) {
                    KeyValueBean keyValueBean = (KeyValueBean) adapter.getItem(position);
                    mSelectParentKey = keyValueBean.getKey();
                    mOnParentSelectListener.getValue(keyValueBean.getValue(), mSelectParentKey, keyValueBean.getKey());
                }else
    ...
    public void setOnParentSelectListener(OnSelectListener onParentSelectListener) {
        mOnParentSelectListener = onParentSelectListener;
    }
